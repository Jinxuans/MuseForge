...
export function deleteCachedImageAndThumbnail(id: string) {
  imageCache.delete(id)
  thumbnailCache.delete(id)
}

export function deleteCachedImageState(id: string) {
  imageCache.delete(id)
  thumbnailCache.delete(id)
...
export function cacheThumbnail(id: string, thumbnail: { dataUrl: string; width?: number; height?: number; thumbnailVersion?: number }) {
