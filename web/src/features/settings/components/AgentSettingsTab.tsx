...
interface AgentSettingsTabProps {
  ...
  onAgentMaxToolRoundsInputChange: (value: string) => void
  onCommitAgentMaxToolRounds: () => void
...
export default function AgentSettingsTab({
  ...
  onAgentMaxToolRoundsInputChange,
  onCommitAgentMaxToolRounds,
  onCommitSettings,
    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          onChange={(e) => onAgentMaxToolRoundsInputChange(e.target.value)}
          onBlur={onCommitAgentMaxToolRounds}
          type="number"
          min={1}
          max={50}
        ...
        <div className="mb-1 flex items-center justify-between gap-3">
          ...
          <button
            ...
            onClick={() => {
              ...
              onAgentMaxToolRoundsInputChange(String(agentMaxToolRounds))
              onCommitSettings({ ...draft, agentMaxToolRounds, agentWebSearch: !draft.agentWebSearch })
            }}
