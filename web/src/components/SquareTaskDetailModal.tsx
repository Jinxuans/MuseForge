...
export default function SquareTaskDetailModal({ share, onClose, onCopyPrompt, onUsePrompt }: SquareTaskDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/35 p-4 backdrop-blur-sm" onClick={onClose}>
      <div
        className="flex max-h-[88vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-white/60 bg-white shadow-2xl dark:border-white/[0.08] dark:bg-gray-900"
