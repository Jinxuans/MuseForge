...
type MaskEditorToolbarProps = {
  tool: MaskTool
  setTool: Dispatch<SetStateAction<MaskTool>>
  brushSize: number
  ...
  canUndo: boolean
  canRedo: boolean
  brushSizeControlRef: RefObject<HTMLDivElement | null>
  brushSizeButtonRef: RefObject<HTMLButtonElement | null>
  onToggleBrushControls: () => void
  onUndo: () => void
  onRedo: () => void
  onResetView: () => void
  onClear: () => void
